const Banner = () => {
  return (
    <div className="h-[600px] w-full">
      <div className="h-[100%] w-full  bg-[url(/assets/Banner.png)]  lg:bg-cover flex items-center  bg-center bg-no-repeat">
        <div className="h-[450px] w-[80%] mx-auto flex items-center">
          <div className="lg:w-[45%]  h-[300px]">
            <h2 className="text-3xl font-semibold">Year end sale</h2>
            <h1 className="lg:text-5xl text-2xl font-semibold text-[#e12503] mt-3">
